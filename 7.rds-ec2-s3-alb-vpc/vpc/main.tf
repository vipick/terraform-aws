...
resource "aws_vpc" "vpc" {
  ...
  tags = {
    Name    = "saju-vpc-${var.service_type}"  //이름 태그
...
resource "aws_subnet" "public-subnet-1" {
  ...
  tags = {
    Name = "saju-public-subnet1-${var.service_type}" //서브넷 이름
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_subnet" "public-subnet-2" {
  ...
  map_public_ip_on_launch = true
  tags = {
    Name = "saju-public-subnet2-${var.service_type}"
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_subnet" "private-subnet-1" {
  ...
  tags = {
    Name = "saju-private-subnet1-${var.service_type}"
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_subnet" "private-subnet-2" {
  ...
  availability_zone = "ap-northeast-2b"
  tags = {
    Name = "saju-private-subnet2-${var.service_type}"
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_internet_gateway" "igw" {
  ...
  tags = {
    Name = "saju-igw-${var.service_type}"
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_nat_gateway" "natgw" {
  ...
  tags = {
    Name = "saju-natgw-${var.service_type}"
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_route_table" "public-rt" {
  ...
  tags = {
    Name = "saju-public-rt-${var.service_type}"    //라우팅 테이블 이름
    Service = "saju-${var.service_type}"
  }
}
...
resource "aws_route_table" "private-rt" {
  ...
  tags = {
    Name = "saju-private-rt-${var.service_type}"
    Service = "saju-${var.service_type}"
  }
}
